    ...
    <Layout title="@vinhvn | links">
      ...
      >
        <div id="content" className="pb-24">
          ...
          <LinkContainer from="black" to="gray-800">
          ...
          <LinkContainer from="yellow-900" to="yellow-700">
            <div className="absolute left-0 ml-2 top-1/2 transform -translate-y-1/2">
          ...
          <LinkContainer from="red-700" to="red-500">
            <div className="absolute left-0 ml-2 top-1/2 transform -translate-y-1/2">
          ...
          <LinkContainer from="yellow-700" to="yellow-500">
            <div className="absolute left-0 ml-2 top-1/2 transform -translate-y-1/2">
          ...
          <LinkContainer from="yellow-500" to="yellow-300">
            <div className="absolute left-0 ml-2 top-1/2 transform -translate-y-1/2">
          ...
          <LinkContainer from="green-600" to="green-400">
            <div className="absolute left-0 ml-2 top-1/2 transform -translate-y-1/2">
          ...
          <LinkContainer from="blue-600" to="blue-400">
            <div className="absolute left-0 ml-2 top-1/2 transform -translate-y-1/2">
          ...
          <LinkContainer from="indigo-500" to="purple-500">
            <div className="absolute left-0 ml-2 top-1/2 transform -translate-y-1/2">
        ...
        <div id="footer" className="">
          ...
          <div className="flex justify-center items-center bg-red-500 rounded-lg shadow transform duration-300 hover:-translate-y-1 hover:shadow-lg">
